...
Flowet for authentication fungerer således at en bruger logger ind med email og password. Herefter hvis de bliver bekræftet som en eksisterende user i backend, vil de modtage en Refresh Token i JWT (JSON Web Token) format der indeholder deres UserID, som bliver gemt i clientens cookies.
