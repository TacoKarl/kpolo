...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item[R4] Udviklerne er ikke samstemt om kodekonventioner og introducerer redundanser og svært overskuelig kode, der fører til større refaktoreringer og lang tid til code reviews.
    \end{itemize}
...
Sandsynlighed og konsekvensgrad vurderes på en skala fra 1 til 5, hvor 1 er lav og 5 er høj.
...
\subsection{Yderligere applikationsniveau risici}\label{sec:yderligere-risici}
Disse punkter er ikke relateret til risici i forbindelse med udviklingsprocessen, men snarere risici forbundet med selve applikationen og dens kommercielle potentiale.
